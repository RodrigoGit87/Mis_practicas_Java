...
public class Condicionales {
    static void main (){
        /*IF ELSE, ELSE IF. Aqui establecemos que se ejecute un código u otro segun la condición que se cumpla */
        var age = 18;
        IO.println( age >= 18);
            if (age > 18){
        ...
        /* SWITCH. En los switch no establecemos una condicion como tal, sino que inspeccionamos el valor de una
