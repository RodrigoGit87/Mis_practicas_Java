...
public class Strings {
    static void main(String[] args){
        String name = "Sandra la morsa";
        String surname = "llamas";
        ...
        //obtener caracter
        IO.println(name.charAt(3)); //en los parentesis pongo la posicion del indice (recordar siempre empieza en 0).

        IO.println(name.charAt(name.length()-1));/*Si quiero el último caracter del string y no sé el numero de posicion
        ...
        IO.println ("Hola java".toUpperCase().contains("AVA"));/*El resultado es true por que aunque el string original
        está en minuscula, he "forzado con toUpperCase y luego el valor en contains lo escribo en mayus para comprobar*/
        ...
        IO.println (a == c);/*Aqui da false por que aunque tiene el mismo valor, entiende que es un objeto creado de
        otra forma (con new String) y no lo da por bueno o igual. Por eso se usa el equals.*/
        ...
        var age=38;
        /*Aplicando el formateo se consigue que el valor de una variable que tengamos(string o entero o decimal %f) se
        utilize en el texto que estemos haciendo. Y asi si cambia el valor de la variable, cambiará en el texto automa
        ticamente*/
